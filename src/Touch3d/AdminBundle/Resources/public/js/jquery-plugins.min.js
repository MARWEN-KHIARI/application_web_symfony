...
/** bootbox.js */
var bootbox=window.bootbox||function(e){function l(e,r){if(r==null){r=t}if(typeof f[r][e]=="string"){return f[r][e]}if(r!=n){return l(e,n)}return e}var t="en",n="en",r=true,i="static",s="javascript:;",o="",u={},a={};var f={en:{OK:"OK",CANCEL:"Cancel",CONFIRM:"OK"},fr:{OK:"OK",CANCEL:"Annuler",CONFIRM:"D'accord"},de:{OK:"OK",CANCEL:"Abbrechen",CONFIRM:"Akzeptieren"},es:{OK:"OK",CANCEL:"Cancelar",CONFIRM:"Aceptar"},br:{OK:"OK",CANCEL:"Cancelar",CONFIRM:"Sim"},nl:{OK:"OK",CANCEL:"Annuleren",CONFIRM:"Accepteren"},ru:{OK:"OK",CANCEL:"Отмена",CONFIRM:"Применить"},it:{OK:"OK",CANCEL:"Annulla",CONFIRM:"Conferma"}};a.setLocale=function(e){for(var n in f){if(n==e){t=e;return}}throw new Error("Invalid locale: "+e)};a.addLocale=function(e,t){if(typeof f[e]=="undefined"){f[e]={}}for(var n in t){f[e][n]=t[n]}};a.setIcons=function(e){u=e;if(typeof u!=="object"||u==null){u={}}};a.alert=function(){var e="",t=l("OK"),n=null,r="Nepoznat";e=arguments[0];r=arguments[1];return a.dialog(e,{label:t,icon:u.OK,callback:n},{onEscape:n,header:r,keyboard:true})};a.confirm=function(){var e="",t=l("CANCEL"),n=l("CONFIRM"),r=null;switch(arguments.length){case 1:e=arguments[0];break;case 2:e=arguments[0];if(typeof arguments[1]=="function"){r=arguments[1]}else{t=arguments[1]}break;case 3:e=arguments[0];t=arguments[1];if(typeof arguments[2]=="function"){r=arguments[2]}else{n=arguments[2]}break;case 4:e=arguments[0];t=arguments[1];n=arguments[2];r=arguments[3];break;default:throw new Error("Incorrect number of arguments: expected 1-4");break}return a.dialog(e,[{label:t,icon:u.CANCEL,callback:function(){if(typeof r=="function"){r(false)}}},{label:n,icon:u.CONFIRM,callback:function(){if(typeof r=="function"){r(true)}}}])};a.prompt=function(){var t="",n=l("CANCEL"),r=l("CONFIRM"),i=null,s="";switch(arguments.length){case 1:t=arguments[0];break;case 2:t=arguments[0];if(typeof arguments[1]=="function"){i=arguments[1]}else{n=arguments[1]}break;case 3:t=arguments[0];n=arguments[1];if(typeof arguments[2]=="function"){i=arguments[2]}else{r=arguments[2]}break;case 4:t=arguments[0];n=arguments[1];r=arguments[2];i=arguments[3];break;case 5:t=arguments[0];n=arguments[1];r=arguments[2];i=arguments[3];s=arguments[4];break;default:throw new Error("Incorrect number of arguments: expected 1-5");break}var o=t;var f=e("<form></form>");f.append("<input autocomplete=off type=text value='"+s+"' />");var c=a.dialog(f,[{label:n,icon:u.CANCEL,callback:function(){if(typeof i=="function"){i(null)}}},{label:r,icon:u.CONFIRM,callback:function(){if(typeof i=="function"){i(f.find("input[type=text]").val())}}}],{header:o});c.on("shown",function(){f.find("input[type=text]").focus();f.on("submit",function(e){e.preventDefault();c.find(".btn-primary").click()})});return c};a.modal=function(){var t;var n;var r;var s={onEscape:null,keyboard:true,backdrop:i};switch(arguments.length){case 1:t=arguments[0];break;case 2:t=arguments[0];if(typeof arguments[1]=="object"){r=arguments[1]}else{n=arguments[1]}break;case 3:t=arguments[0];n=arguments[1];r=arguments[2];break;default:throw new Error("Incorrect number of arguments: expected 1-3");break}s["header"]=n;if(typeof r=="object"){r=e.extend(s,r)}else{r=s}return a.dialog(t,[],r)};a.dialog=function(t,n,u){var a=null,f="",l=[],u=u||{};if(n==null){n=[]}else if(typeof n.length=="undefined"){n=[n]}var c=n.length;while(c--){var h=null,p=null,d=null,v="",m=null;if(typeof n[c]["label"]=="undefined"&&typeof n[c]["class"]=="undefined"&&typeof n[c]["callback"]=="undefined"){var g=0,y=null;for(var b in n[c]){y=b;if(++g>1){break}}if(g==1&&typeof n[c][b]=="function"){n[c]["label"]=y;n[c]["callback"]=n[c][b]}}if(typeof n[c]["callback"]=="function"){m=n[c]["callback"]}if(n[c]["class"]){d=n[c]["class"]}else if(c==n.length-1&&n.length<=2){d="btn-primary"}if(n[c]["label"]){h=n[c]["label"]}else{h="Option "+(c+1)}if(n[c]["icon"]){v="<i class='"+n[c]["icon"]+"'></i> "}if(n[c]["href"]){p=n[c]["href"]}else{p=s}f+="<a data-handler='"+c+"' class='btn "+d+"' href='"+p+"'>"+v+""+h+"</a>";l[c]=m}var w=["<div class='bootbox modal' style='overflow:hidden;'>"];if(u["header"]){var E="";if(typeof u["headerCloseButton"]=="undefined"||u["headerCloseButton"]){E="<a href='"+s+"' class='close'>x</a>"}w.push("<div class='modal-header'>"+E+"<h3>"+u["header"]+"</h3></div>")}w.push("<div class='modal-body'></div>");if(f){w.push("<div class='modal-footer'>"+f+"</div>")}w.push("</div>");var S=e(w.join("\n"));var x=typeof u.animate==="undefined"?r:u.animate;if(x){S.addClass("fade")}var T=typeof u.classes==="undefined"?o:u.classes;if(T){S.addClass(T)}e(".modal-body",S).html(t);S.bind("hidden",function(){S.remove()});S.bind("hide",function(){if(a=="escape"&&typeof u.onEscape=="function"){u.onEscape()}});e(document).bind("keyup.modal",function(e){if(e.which==27){a="escape"}});S.bind("shown",function(){e("a.btn-primary:last",S).focus()});S.on("click",".modal-footer a, a.close",function(t){var r=e(this).data("handler"),i=l[r],s=null;if(typeof r!=="undefined"&&typeof n[r]["href"]!=="undefined"){return}t.preventDefault();if(typeof i=="function"){s=i()}if(s!==false){a="button";S.modal("hide")}});if(u.keyboard==null){u.keyboard=typeof u.onEscape=="function"}e("body").append(S);S.modal({backdrop:typeof u.backdrop==="undefined"?i:u.backdrop,keyboard:u.keyboard});return S};a.hideAll=function(){e(".bootbox").modal("hide")};a.animate=function(e){r=e};a.backdrop=function(e){i=e};a.classes=function(e){o=e};return a}(window.jQuery)
